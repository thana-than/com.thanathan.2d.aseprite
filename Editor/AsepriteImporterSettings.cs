...
namespace UnityEditor.U2D.Aseprite
{
    ...
    internal struct AsepriteImporterSettings : IEquatable<AsepriteImporterSettings>
    {
        ...
        [SerializeField] bool m_PerLayerAnimators;
        public bool perLayerAnimators
        {
            get => m_PerLayerAnimators;
            set => m_PerLayerAnimators = value;
        }
        ...
        [SerializeField] bool m_PreserveGroupHierarchy;
        public bool preserveGroupHierarchy
        {
            get => m_PreserveGroupHierarchy;
        ...
        {
            get => m_BalanceGroupPivots;
            set => m_BalanceGroupPivots = value;
        }

        [SerializeField] bool m_UsePivotSortPoint;
        public bool usePivotSortPoint
        {
            get => m_UsePivotSortPoint;
            set => m_UsePivotSortPoint = value;
        }
        ...
        public override int GetHashCode()
        {
            unchecked
            {
                ...
                hashCode = (hashCode * 397) ^ m_PerLayerAnimators.GetHashCode();
